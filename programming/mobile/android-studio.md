...
Pro akceleraci emulátoru ve Windows použij **Windows Hypervisor Platform** a povolenou virtualizaci CPU v UEFI; po zapnutí funkce Windows restartuj počítač.
...
Nejprve připrav [Flutter SDK](flutter/setup-and-configuration.md); samotný plugin IDE jej nenahrazuje.
