...
Osobní vývojářská dokumentace sjednocená podle tematických oblastí. Přehledy a navigace se skládají automaticky ze zdrojových souborů, aby zůstaly konzistentní i při dalším rozšiřování.

## Oblasti

| Oblast | Stránek | Záměr |
| --- | --- | --- |
| [AI](ai/index.md) | 1 | Nástroje a postupy pro práci s lokálními i vývojářskými modely umělé inteligence. |
| [Verzování](vcs/index.md) | 15 | Praktické postupy pro Git, větve, historii a běžnou správu repozitářů. |
| [IDE](ide/index.md) | 2 | Nastavení a používání vývojových prostředí pro každodenní práci. |
| [Programování](programming/index.md) | 43 | Vývojové platformy, jazyky, frameworky, balíčky a opakovaně použitelné postupy. |
| [Databáze](database/index.md) | 5 | Databázové systémy, dotazy a nástroje pro přístup k datům. |
...
| [Síť](network/index.md) | 7 | Síťové technologie, přístupy, certifikáty a bezpečné propojení prostředí. |
...
- Historie změn: [Změny](changelog.md).
